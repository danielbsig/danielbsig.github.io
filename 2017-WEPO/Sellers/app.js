...
*/
	function initializeTemplates() {
		...
		$scope.result    = "";
		$scope.templates = [];
		$scope.templates.push(addTemplate(5,  "List sellers"));
		$scope.templates.push(addTemplate(10, "Add/edit seller"));
		$scope.templates.push(addTemplate(10, "Show seller details"));
		$scope.templates.push(addTemplate(10, "All products tab"));
		$scope.templates.push(addTemplate(5,  "Top 10 products"));
		$scope.templates.push(addTemplate(10, "Add/edit products"));
		$scope.templates.push(addTemplate(10, "Validation"));
		$scope.templates.push(addTemplate(5,  "Toastr (or similar) feedback after add/edit"));
		$scope.templates.push(addTemplate(5,  "Responsive layout"));
		$scope.templates.push(addTemplate(30, "Unit tests for all code"));
		$scope.templates.push(addTemplate(10, "Coolness bonus", true));
	}

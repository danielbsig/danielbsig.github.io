...
app.controller("TemplateController", function($scope, $timeout) {
	...
	function initializeTemplates() {
		...
		$scope.result    = "";
		$scope.templates = [];
		$scope.templates.push(addTemplate(20, "Player in same X pos, jumps on space"));
		$scope.templates.push(addTemplate(10, "Pipes and ground move to the left"));
		$scope.templates.push(addTemplate(10, "Player dies on collision"));
		$scope.templates.push(addTemplate(5,  "One point for each gap"));
		$scope.templates.push(addTemplate(10, "Display score and restart when game is lost"));

		$scope.templates.push(addTemplate(10, "Hardware accelerated"));
		$scope.templates.push(addTemplate(10, "Parallax element (such as a cloud)"));
		$scope.templates.push(addTemplate(10, "Wing animation (or similar)"));
		$scope.templates.push(addTemplate(15, "Background music, mute support"));

		$scope.templates.push(addTemplate(10, "Bonus points", true));
	}

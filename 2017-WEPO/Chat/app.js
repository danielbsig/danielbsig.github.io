...
*/
	function initializeTemplates() {
		...
		$scope.result    = "";
		$scope.templates = [];
		$scope.templates.push(addTemplate(10, "User provides a nick"));
		$scope.templates.push(addTemplate(10, "List of rooms"));
		$scope.templates.push(addTemplate(5, "Join/leave a chat room"));
		$scope.templates.push(addTemplate(15, "Send message inside a room"));
		$scope.templates.push(addTemplate(10, "Send a private message"));
		$scope.templates.push(addTemplate(15, "Kick a user"));
		$scope.templates.push(addTemplate(15, "Components in separate files, concat/minify"));
		$scope.templates.push(addTemplate(10, "Dependencies installed using Bower/NPM"));
		$scope.templates.push(addTemplate(10, "No JSLint errors"));
	}

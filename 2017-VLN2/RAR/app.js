...
app.controller("TemplateController", function($scope, $timeout) {
	...
	function initializeTemplates() {
		...
		$scope.assignment = "Requirement Analysis Report";
		$scope.student    = "";
		$scope.result     = "";
		$scope.templates  = [];
		$scope.templates.push(addTemplate(10, "Introduction"));
		$scope.templates.push(addTemplate(25, "Requirement list"));
		$scope.templates.push(addTemplate(25, "Use cases/Scenarios"));
		$scope.templates.push(addTemplate(20, "Interviews"));
		$scope.templates.push(addTemplate(10, "General tidyness"));

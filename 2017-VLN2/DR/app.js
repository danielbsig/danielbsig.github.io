...
app.controller("TemplateController", function($scope, $timeout) {
	...
	function initializeTemplates() {
		...
		$scope.assignment = "Design Report";
		$scope.student    = "";
		$scope.result     = "";
		$scope.templates  = [];
		$scope.templates.push(addTemplate(10, "Introduction"));
		$scope.templates.push(addTemplate(15, "Navigation diagram"));
		$scope.templates.push(addTemplate(20, "Page prototypes"));
		$scope.templates.push(addTemplate(15, "Class diagram (+table diagram)"));
		$scope.templates.push(addTemplate(15, "Programming rules"));
		$scope.templates.push(addTemplate(5,  "General tidyness"));
		$scope.templates.push(addTemplate(20, "Other"));
	}
